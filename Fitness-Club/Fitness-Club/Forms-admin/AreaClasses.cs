...
{
    public partial class AreaClasses : Form
    {
        ...
        public AreaClasses(List <Person> listP,List<Classes>listC)
        {
            this.listC = listC;
            this.listP = listP;
            InitializeComponent();
        ...
        {
            LoginANDRegister.activePanel(lblAbout, panelAbout);
            LoginANDRegister.inactivePanel(lblEditor, panelEditor);
            LoginANDRegister.inactivePanel(lblFriends, panelFriends);
        ...
        {
            LoginANDRegister.activePanel(lblFriends, panelFriends);
            LoginANDRegister.inactivePanel(lblEditor, panelEditor);
            LoginANDRegister.inactivePanel(lblAbout, panelAbout);
        ...
        {
            LoginANDRegister.activePanel(lblEditor, panelEditor);
            LoginANDRegister.inactivePanel(lblAbout, panelAbout);
            LoginANDRegister.inactivePanel(lblFriends, panelFriends);
            panelDataAbout.Visible = false;
            panelListFriends.Visible = false;
